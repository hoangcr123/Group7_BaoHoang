...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ DiDongViet" title="Trang chủ DiDongViet">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Website Sale Moblie Hutech</a> - Code Bán Điện Thoại Tháng 5 Năm 2023 - Bản Quyền Thuộc
            <span style="color: #eee; font-weight: bold">Code Đồ Án Công Nghệ Thông Tin Nguyễn Bảo Hoàng</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giao hàng hỏa tốc trong 2 giờ</li>
                <li>  Thanh toán linh hoạt </li>
                <li>Trải nghiệm sản phẩm ngay</li>
                <li>Lỗi 1 đổi 1 trong 30 ngày</li>
                <li>Bảo hành trọn đời.
                    <br>Hotline:
                    <a href="tel:0914472818" style="color: #288ad6;">0914472818</a>
                </li>
            </ul>
        </section>
    </div>`);
