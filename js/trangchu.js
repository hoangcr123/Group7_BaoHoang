window.onload = function () {
	...
	addAlertBox('Di Động Việt Xin Kính Chào Quý Khách', '#5f5', '#000', 5000); 
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('SẢN PHẨM HOT', yellow_red, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('HÀNG MỚI VỀ', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('HÀNG TRẢ GÓP 0%', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM GIÁ SỐC ONLINE', green, ['promo=giareonline', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM SẬP SÀN ', yellow_red, ['promo=giamgia'], soLuong, div);
		addKhungSanPham('GIÁ RẺ HÀNG CHẤT LƯỢNG', green, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
